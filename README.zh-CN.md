...
<p align="center">
  ...
  Brainstorm Skill 可以把口播、SRT 字幕、会议碎片和脑暴记录，整理成有结构、有连接逻辑、有出场节奏的流程图与动效 brief。
</p>

<p align="center">
  <a href="https://github.com/julilaoshi/brainstorm-skill"><img alt="给仓库点星" src="https://img.shields.io/badge/给仓库-点星-f6c343?style=for-the-badge&logo=github&logoColor=111111" /></a>
...
- [给仓库点星](https://github.com/julilaoshi/brainstorm-skill)
...
Brainstorm Skill 处理的是下一步：把已经说出来、写下来、堆在一起的想法，整理成别人能在会议、课堂、视频或产品演示里看懂的流程。
...
这个 public 仓库聚焦 Brainstorm Skill 本身。
...
- `skill/SKILL.md` - Brainstorm Skill 公开版
...
- Skill 名在两个版本里都保持 `Brainstorm Skill`。
